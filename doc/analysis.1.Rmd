...
It contains `r N(nrow(glyco))` entires with `r N(length(refseq))` unique RefSeq identifiers. This is a result of mapping RefSeq IDs to UniProt. I use Ensembl to map these RefSeq IDs (I ignore UniProt here) into Ensembl IDs used in this work.
